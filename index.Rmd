...
write.csv(bioma, "arquivos/biomas.csv", row.names = FALSE)
write.csv(categoriaAmeaca, "arquivos/categoria_ameaca.csv", row.names = FALSE)
write.csv(estados, "arquivos/estados.csv", row.names = FALSE)
write.csv(principaisAmeacas, "arquivos/principais_ameacas.csv", row.names = FALSE)
...
write.csv(especies, "arquivos/especies.csv", row.names = FALSE)
```
